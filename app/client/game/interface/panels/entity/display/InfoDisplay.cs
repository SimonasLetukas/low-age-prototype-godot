...
public partial class InfoDisplay : MarginContainer
{
    ...
    public override void _Ready()
    {
        ...
        _activateAbility.Clicked += OnActivateAbilityClicked;
        ...
        bool hasAbilityToActivate)
    {
        ...
        _valueResearchText = string.Join(", ", research.Select(x => 
            GlobalRegistry.Instance.GetResearchById(x).DisplayName));
    ...
    private void OnActivateAbilityClicked() => AbilityActivated();
