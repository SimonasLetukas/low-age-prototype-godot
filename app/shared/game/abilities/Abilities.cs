                     ...
                     id => id, (ability, id) => ability))
        {
            switch (abilityBlueprint)
            {
                case Build buildBlueprint:
                    ...
                    break;
                case Instant instantBlueprint:
                    var instant = InstantNode.InstantiateAsChild(instantBlueprint, this, Parent);
                    instant.ExecutionRequested += OnExecutionRequested;
                    break;
                case Passive passiveBlueprint:
                    ...
                    break;
                case Research researchBlueprint:
                    var research = ResearchNode.InstantiateAsChild(researchBlueprint, this, Parent);
                    research.ExecutionRequested += OnExecutionRequested;
                    break;
