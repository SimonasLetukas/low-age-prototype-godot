...
public static class Vector2Extensions
{
    ...
    public static Vector2Int ToVector2(this Vector2 godotVector2) => new((int)godotVector2.X, (int)godotVector2.Y);
    
    public static Vector2Int ToVector2(this Vector2I godotVector2) => new(godotVector2.X, godotVector2.Y);
    
    public static Vector2 ToGodotVector2(this Vector2Int domainVector2) 
        => new(Convert.ToSingle(domainVector2.X), Convert.ToSingle(domainVector2.Y));
    
    public static Vector2I ToGodotVector2I(this Vector2Int domainVector2) 
