...
/// <summary>
/// Various changes to the <see cref="Entity"/> stats and effects executed at the start and end. 
/// </summary>
public class Buff : Behaviour
{
    public Buff(
        ...
        string description,
        string sprite,
        IList<EntityModificationFlag>? modificationFlags = null,
    ...
    {
        ModificationFlags = modificationFlags ?? new List<EntityModificationFlag>();
    ...
    /// <summary>
    /// Added at the start of behaviour, removed before end or destroy (except when
    /// <see cref="Behaviour.RemoveOnConditionsMet"/> is true).
    /// </summary>
    public IList<EntityModificationFlag> ModificationFlags { get; }
    ...
    /// end or destroy (skipped when <see cref="Behaviour.RemoveOnConditionsMet"/> is true).
    /// </summary>
