...
namespace low_age_data.Domain.Entities.Features
{
    public class FeatureName : EntityName
    {
        ...
        public static FeatureName RadarRedDot => new FeatureName(nameof(RadarRedDot).ToKebabCase());
        public static FeatureName VesselFortification => new FeatureName(nameof(VesselFortification).ToKebabCase());
        public static FeatureName OmenRendition => new FeatureName(nameof(OmenRendition).ToKebabCase());
    }
}
