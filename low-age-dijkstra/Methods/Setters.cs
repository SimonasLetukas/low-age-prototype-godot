namespace low_age_dijkstra.Methods
{
    public static class Setters
    {
        ...
        /// </summary>
        /// <param name="dijkstraMap"><see cref="DijkstraMap"/></param>
        ...
        public static bool AddPoint(this DijkstraMap dijkstraMap, PointId id, Terrain? terrain = null)
        {
        ...
        internal static void AddOrReplacePoint(this DijkstraMap dijkstraMap, PointId id, Terrain terrain)
        {
        ...
        /// and removed.
        public static bool RemovePoint(this DijkstraMap dijkstraMap, PointId id)
        {
        ...
        public static bool DisablePoint(this DijkstraMap dijkstraMap, PointId id)
        {
        ...
        public static bool EnablePoint(this DijkstraMap dijkstraMap, PointId id)
        {
            if (dijkstraMap.HasPoint(id) is false 
        ...
        /// were not found.
        public static bool ConnectPoints(this DijkstraMap dijkstraMap, PointId source, PointId target, 
        ...
        public static bool RemoveConnection(this DijkstraMap dijkstraMap, PointId source, PointId target, 
        ...
        public static bool SetTerrainForPoint(this DijkstraMap dijkstraMap, PointId id, Terrain terrain)
        {
            if (dijkstraMap.Points.TryGetValue(id, out var pointInfo) is false)
                return false;
