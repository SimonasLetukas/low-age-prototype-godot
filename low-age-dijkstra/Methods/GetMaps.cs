...
namespace low_age_dijkstra.Methods
{
    public static class GetMaps
    {
        ...
        public static PointId GetDirectionAtPoint(this DijkstraMap dijkstraMap, PointId point) 
        ...
        public static Cost GetCostAtPoint(this DijkstraMap dijkstraMap, PointId point) 
            => dijkstraMap.ComputedInfo.TryGetValue(point, out var pointComputedInfo) 
                ? pointComputedInfo.Cost 
                : Cost.Infinity;
        
        /// Returns the entire Dijkstra map of directions and costs.
        public static Dictionary<PointId, PointComputedInfo> GetDirectionAndCostMap(this DijkstraMap dijkstraMap) 
            => dijkstraMap.ComputedInfo;

        /// Returns all points with costs between `minCost` and `maxCost` (inclusive), sorted by cost.
        public static IEnumerable<PointId> GetAllPointsWithCostBetween(this DijkstraMap dijkstraMap, 
