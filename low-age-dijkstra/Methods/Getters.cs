...
namespace low_age_dijkstra.Methods
{
    public static class Getters
    {
        ...
        public static PointId GetAvailableId(this DijkstraMap dijkstraMap, PointId above = null)
        {
        ...
        public static bool HasPoint(this DijkstraMap dijkstraMap, PointId point) 
        ...
        public static bool HasConnection(this DijkstraMap dijkstraMap, PointId source, PointId target) 
        ...
        public static Terrain GetTerrainForPoint(this DijkstraMap dijkstraMap, PointId id) 
            => dijkstraMap.Points.TryGetValue(id, out var pointInfo) 
                ? pointInfo.Terrain 
                : Terrain.Default;

        /// Returns true if `point` exists and is disabled.
        public static bool IsPointDisabled(this DijkstraMap dijkstraMap, PointId point) 
        ...
        public static IEnumerable<PointId> GetShortestPathFromPoint(this DijkstraMap dijkstraMap, PointId point) 
            => new ShortestPathIterator(dijkstraMap, point);

        private class ShortestPathIterator : IEnumerable<PointId>
        {
            private readonly DijkstraMap _dijkstraMap;
            private PointId _nextPoint;

            public ShortestPathIterator(DijkstraMap map, PointId startPoint)
            {
                _dijkstraMap = map;
