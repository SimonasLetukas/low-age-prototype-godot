...
{
    /// <summary>
    /// Controls the direction of the <see cref="DijkstraMap"/> in <see cref="DijkstraMap.Recalculate"/>.
    /// </summary>
    ...
    /// <para> - Populate the map with <see cref="DijkstraMap.AddPoint"/>, <see cref="DijkstraMap.ConnectPoints"/>...</para>
    /// <para> - Compute the shortest paths with <see cref="DijkstraMap.Recalculate"/>.</para>
    /// </summary>
    public class DijkstraMap
    {
        ...
        /// Clears the <see cref="DijkstraMap"/> of all points and connections.
        public void Clear()
        {
            Points.Clear();
            ComputedInfo.Clear();
        ...
        /// Duplicates existing <see cref="DijkstraMap"/> into a new copy.
        public DijkstraMap DuplicateGraph()
        {
