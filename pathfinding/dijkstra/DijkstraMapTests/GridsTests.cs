...
public class GridsTests
{
    ...
    public void AddSquareGrid_ShouldCreateGrid_WithGivenInput(int width, int height, int xOffset, int yOffset, float? diagonalCost)
    {
        var pointsByPosition = _dijkstraMap.AddSquareGrid(width, height, 
            new Vector2Int(xOffset, yOffset), Terrain.Default, 1f, diagonalCost);
        ...
        for (var x = xOffset; x < width + xOffset; x++)
        {
            for (var y = yOffset; y < height + yOffset; y++)
            {
                ...
                var topPosition = position + new Vector2Int(0, 1);
                ...
                var bottomPosition = position + new Vector2Int(0, -1);
                ...
                var rightPosition = position + new Vector2Int(1, 0);
                ...
                var leftPosition = position + new Vector2Int(-1, 0);
                ...
                var topRightPosition = position + new Vector2Int(1, 1);
                ...
                var topLeftPosition = position + new Vector2Int(-1, 1);
                ...
                var bottomRightPosition = position + new Vector2Int(1, -1);
                ...
                var bottomLeftPosition = position + new Vector2Int(-1, -1);
