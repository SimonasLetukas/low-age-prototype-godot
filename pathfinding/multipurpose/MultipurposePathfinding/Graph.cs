...
namespace MultipurposePathfinding
{
    /// <summary>
    /// <para>
    /// Extends <see cref="Dijkstra.DijkstraMap"/> with additional dimensions: size, team. Manages the resulting
    /// multiple <see cref="Dijkstra.DijkstraMap"/>s and <see cref="Point"/>s within.
    /// </para>
    /// <para>
    ...
    internal class Graph
    {
        ...
        private class DijkstraMapBySize : Dictionary<PathfindingSize, Dijkstra> { }

        private Dictionary<Team, DijkstraMapBySize> DijkstraMapBySizeByTeam { get; } = new Dictionary<Team, DijkstraMapBySize>();

        private Dijkstra MainDijkstraMap(Team team) => DijkstraMapBySizeByTeam[team][1];

        private Dictionary<PathfindingSize, Dijkstra> NonMainDijkstraMaps(Team team) => DijkstraMapBySizeByTeam[team]
